...
function FormInput() {
  ...
  return (
    <form className="container" onSubmit={handleSubmit}>
      <div className="close"><a href="landing-page.html" style={{textDecoration:'none'}}>X</a></div>
      <div className="head">
      ...
      <input type="text" placeholder="Masukkan Nama Kamu " id="nama" className="input nama" required value={name} onChange={(e) => setName(e.target.value)} />
        ...
        <div className="cek">
          ...
          <label for="" style={{fontSize: '13px',fontWeight: '300'}}>Setuju dengan S&K</label>
        </div>
      </div>

      <button id="register" className="button" style={{color:'aliceblue', borderColor: 'blue', backgroundColor: 'blue', cursor: 'pointer'}} type="submit">Register</button>
        <p>atau</p>
        ...
        <p >Kamu Sudah Punya Akun?<a id="masuk" href="login.html" style={{color: 'blue'}} data-bs-toggle="modal"
